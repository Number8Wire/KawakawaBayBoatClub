...
<head>
	...
	<?php
		...
		$subject = "Kawakawa bay Boat Club - 401 - Unauthorised";
		$body = "Hi,\n\nA user tried to access a web page " . $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] . " which requires authentication.\n\nYou had better fix this.\n\nThe Web Site :-)";
...
<body data-spy="scroll" data-target="#navbar">
	...
	<div class="container">
		...
		<h3>Sorry - the web page you are looking for "<?echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];?>" requires authentication.</h3>
