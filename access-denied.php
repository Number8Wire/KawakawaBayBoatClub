...
<head>
	...
	<?php
		...
		$result = mysql_query("SELECT DATE_FORMAT(news_date, '%D %b, %Y') AS display_date, news_title FROM news ORDER BY news_date DESC", $link);
		if (!$result) {
...
<body data-spy="scroll" data-target="#navbar">
	...
	<div class="container">
		<div id="home" class="starter-template">
			...
			<h2>Access Denied</h2>
			<h4 align="center">You do not have access to this resource.</h4>
			<hr>
		</div>
	</div><!-- /.container -->
