...
<head>
	...
	function formValidator(){
		...
		if(notEmpty(linkText, "Please enter the text to display for the file link within the news item.")){
			return true;
			}
		else {
			return false;
...
<?php
	...
	if(isset($_GET['linkText'])) {
		$linkText=$_GET['linkText'];
		$sql_query = "UPDATE news SET news_file_link_text = \"" . $linkText . "\" WHERE news_id=\"".$uid."\"";
//		echo $sql_query;
	...
	while ($row = mysql_fetch_array($result, MYSQL_BOTH)) {
		...
		$news .= "<hr width=\"50%\"><h3 align=\"center\">".$title."</h3><p align=\"center\">".$date."</p><p align=\"center\">".$content."</p>\n";
	}
	mysql_close ($link);
?>	
...
<!--					<li><a href="editvessels.php">Vessels</a></li> -->
	...
	<div class="container">
		<div id="home" class="starter-template">
			...
			<h3>Upload News pdf File</h3>
			<hr width="90%">
			
			<p>Please enter the text you would like to display as the link to the file you are about to upload. This text must be entered before you upload the news file.</p>
			<form name="input" action="" method="get" onsubmit='return formValidator()'>
				<input type=hidden name="news_id" value=<?php echo $uid; ?> />
				<input size="80" type="text" name="linkText" id="linkText" />
...
<!--				<div class="col-md-2  d-md-block  d-sm-none">
	...
	<script>
  	...
  	<script src="js/single-upload-pdf.js?v=v10"></script>
