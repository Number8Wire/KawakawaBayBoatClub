...
<head>
	...
	<?php
		...
		while ($row = mysql_fetch_array($result, MYSQL_BOTH)) 
			...
			$gallery .= "<a href=\"images/gallery/".$filename."\" data-gallery><img src=\"images/gallery/thumbs/".$filename."\" /></a>\n";
		}	
		$gallery .= "</div>\n";
...
<body data-spy="scroll" data-target="#navbar">
	...
	<div class="container">
		<div id="home" class="starter-template">
			...
			<div class="col-md-12">
				<h2>Photo Gallery</h2>
				<p>Click on the thumbnail images below to see larger images.</p>
