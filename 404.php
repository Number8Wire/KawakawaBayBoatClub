...
<head>
	...
	<?php
		...
		$subject = "Kawakawa Bay Boat Club - 404 - File Not Found";
		$body = "Hi,\n\nThe web page, " . $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] . ", refered from " . $_SERVER['HTTP_REFERER'] . " ,could not be found on the Kawakawa Bay Boat Club website.\n\nYou had better fix this.\n\nThe Web Site :-)";
...
<body data-spy="scroll" data-target="#navbar">
	...
	<div class="container">
		...
		<h3>Sorry - we couldn't find that page (<?echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];?>).</h3>
