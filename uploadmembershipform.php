...
<!--					<li><a href="editvessels.php">Vessels</a></li> -->
	...
	<div class="container">
		<div id="home" class="starter-template">
			...
			<h3>Upload Membership Form</h3>
			<p>Click on the button below to upload the latest Kawakawa Bay Boat Club Membership Form. This will then be available for viewing from the website under the Membership section.</p>
    ...
    <script src="js/ui-single.js?v=v10"></script>
  	...
  	<script src="js/single-upload-memberapplicationform.js?v=v10"></script>
