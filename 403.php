...
<head>
	...
	<?php
		$to = "support@number8wire.co.nz";
		$headers = 'From: admin@kbbc.co.nz' . PHP_EOL;
		$subject = "Kawakawa Bay Boat Club - 403 - Forbidden";
		$body = "Hi,\n\nA user did not have permission to access " . $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] . " on the Kawakawa Bay Boat Club website server.\n\nYou had better fix this.\n\nThe Web Site :-)";
...
<body data-spy="scroll" data-target="#navbar">
	...
	<div class="container">
		...
		<h3>Sorry - you don't have permission to access "<?echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];?>" on this server.</h3>
		<p>An email has been sent to our Support Guys at Number 8 Wire Design so that we can resolve the problem, thank you.</p>
		<p>Please select a new page from the menu above.</p>
		</div>
	</div><!-- /.container -->
